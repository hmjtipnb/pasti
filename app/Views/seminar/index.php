...
<?= $this->section('title') ?>
PASTI (Prestasi Aktif Mahasiswa Teknologi Informasi) - Daftar Seminar
<?= $this->endSection() ?>
...
<section class="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
    ...
    <div class="relative bg-white/80 backdrop-blur-xl max-w-xl w-full
        ...
        <form id="pendaftaranForm"
           ...
           <?php
$onlineAktif  = $onlineAktif ?? 0;
$offlineAktif = $offlineAktif ?? 0;
?>
...
<div>
    ...
    <?php if(!$onlineAktif && !$offlineAktif): ?>
        <p class="text-red-500 text-sm mt-1">Pendaftaran sedang ditutup.</p>
    <?php endif; ?>
</div>
